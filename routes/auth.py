...
from db.repositories.auth_repository import BUSINESS_ACCOUNT_TYPE, INDIVIDUAL_ACCOUNT_TYPE
...
def _with_token(auth_payload, response_payload, status_code=200):
    ...
    return _auth_response(response_payload, access_token, status_code)
